...
void Graficos::dibujarCuadro(TilePosition* p, int tilesAncho, int tilesAlto, Color c, bool relleno){
	Broodwar->drawBox(CoordinateType::Map, p->x() * 32, p->y() * 32, p->x() * 32 + tilesAncho * 32, p->y() * 32 + tilesAlto * 32, c, relleno);
}
